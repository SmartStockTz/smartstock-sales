...
@Component({
  ...
  template: `
    <mat-sidenav-container class="match-parent">
      ...
      >
        <app-cart
          [channel]="isViewedInWholesale ? 'whole' : 'retail'"
      ...
      <mat-sidenav-content style="display:flex; flex-direction: column">
        ...
        <app-on-fetch
          [isLoading]="(salesState.fetchProductsProgress | async) == true"
        ...
        <cdk-virtual-scroll-viewport
          ...
          *ngIf="(salesState.fetchProductsProgress | async) === false"
          itemSize="{{
            (deviceState.isSmallScreen | async) === true ? '80' : '30'
          }}"
        >
          <mat-nav-list>
            <app-product-card
              ...
              *cdkVirtualFor="
                let product of salesState.products | async;
                let idx = index
              "
            >
            </app-product-card>
        ...
        <div class="bottom-actions-container">
          <button
            ...
            style="margin: 16px"
            *ngIf="
              (salesState.fetchProductsProgress | async) === false &&
          ...
          <app-cart-preview
            [cartSidenav]="cartdrawer"
            [isWholeSale]="isViewedInWholesale"
          ></app-cart-preview>
        </div>
      </mat-sidenav-content>
