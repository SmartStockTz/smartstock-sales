  ...
  template: `
    <div class="customers-container">
      <table mat-table [dataSource]="dataSource" matSort>
        ...
        <tr class="customers-table-header" mat-header-row *matHeaderRowDef="displayColumns"></tr>
        <tr mat-row class="table-data-row"
            *matRowDef="let row; columns: displayColumns;"></tr>
      </table>
      <app-data-not-ready *ngIf="dataSource.data.length===0"></app-data-not-ready>
    </div>
  `,
  styleUrls: ['../styles/customers-table.style.css', '../styles/customers-page.style.css']
})
export class CustomersTableComponent implements OnInit, OnDestroy, AfterViewInit {
